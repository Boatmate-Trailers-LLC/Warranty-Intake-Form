...
1. `dealer_name`
   ...
   - control: text input
   - required: yes
   - layout: row 1 full width

2. `dealer_address`
   - label: `Address`
   - control: text input
   - required: yes
   - layout: row 2 full width

3. `dealer_city`
   - label: `City`
   - control: text input
   - required: yes
   - layout: row 3 left column

4. `dealer_region`
   - label: `State/Province/Region`
   - control: text input
   - required: yes
   - layout: row 3 right column

5. `dealer_postal_code`
   - label: `Zip/Postal Code`
   - control: text input
   - required: yes
   - layout: row 4 left column
